...
import com.mohit.socialnetworkinapp.Activities.Mypost;
...
public class postadapter extends RecyclerView.Adapter<postadapter.viewholder> {
    ...
    public postadapter(ArrayList<postmodel> post, Context context) {
        this.post = post;
    ...
    public void onBindViewHolder(@NonNull @NotNull postadapter.viewholder holder, int position) {
        ...
        database.getReference().child("Posts").child(model.getUid()).child(model.getPostid()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if(snapshot.exists())
                {
    ...
    public class viewholder extends RecyclerView.ViewHolder {
        ...
        TextView nooflike,share,comment,username,date,caption,time;
